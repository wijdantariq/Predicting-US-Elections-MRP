...
Include a discussion on how the data was obtained and point out any biases if there are any. e.g. 'the frame for the survey is all Xbox users so women are less likely to be sampled....'. We need to include a discussion like this about UCLA and ACS datasets.
